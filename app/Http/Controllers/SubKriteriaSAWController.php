...
class SubKriteriaSAWController extends Controller
{
    /**
     ...
     */
    public function show(SubKriteriaSAW $subKriteria)
    {
        //
    }
     ...
     */
    public function edit(SubKriteriaSAW $subKriteria, Request $request)
    {
        $query = SubKriteriaSAW::where('uuid', $request->uuid)->first();
     ...
     */
    public function update(Request $request, SubKriteriaSAW $subKriteria)
    {
        $rules = [
            'sub_kriteria' => 'required',
            'bobot' => 'required',
        ...
        if ($validator->fails()) {
            ...
            SubKriteriaSAW::where('uuid', $request->current_uuid)->update($data);
            return response()->json(['success' => "Sub Kategori berhasil di tanbahkan"]);
        }
    }
     ...
     */
    public function destroy(Request $request, SubKriteriaSAW $subKriteria)
    {
        SubKriteriaSAW::where('uuid', $request->uuid)->delete();
        return response()->json(['success' => "Data Berhaswi Di hapus"]);
    }

    public function dataTablesSubKriteria(Request $request)
    {
        $query = SubKriteriaSAW::where('kriteria_uuid', $request->kriteria_uuid)->get();
